...
root = "/sibcb1/bioinformatics/yangyue/project/immunotherapy/7.5.cNMF_Neutrophils/cnmf_Neutrophils_out"
...
outdir = '/sibcb1/bioinformatics/yangyue/project/immunotherapy/7.5.cNMF_Neutrophils/Example_refbuilder_Neutrophils'
prefix = 'starcat_ref'
...
topgene_dir = os.path.join(outdir, "top_genes_by_cGEP_Neutrophils")
