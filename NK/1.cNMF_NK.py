...
# 路径配置（NK）
# =============================
h5ad_dir = "/sibcb1/bioinformatics/yangyue/project/immunotherapy/1.TISCH_data_NK"
qc_dir   = "/sibcb1/bioinformatics/yangyue/project/immunotherapy/7.3.cNMF_NK/h5ad_NK_QC/"
out_dir  = "/sibcb1/bioinformatics/yangyue/project/immunotherapy/7.3.cNMF_NK/cnmf_NK_out/"
...
for h5ad_file in sorted(os.listdir(h5ad_dir)):
    ...
    plt.title(f"{dataset} cNMF K selection (NK)")
    plt.legend()
    plt.tight_layout()
    plt.savefig(
    ...
    print(f"🎯 Final cNMF finished for {dataset} (NK, K*={best_k}, 200 iters)")