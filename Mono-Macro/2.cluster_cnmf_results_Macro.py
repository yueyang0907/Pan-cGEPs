...
root = "/sibcb1/bioinformatics/yangyue/project/immunotherapy/7.4.cNMF_Mono_Macro/cnmf_Mono_Macro_out"
...
outdir = '/sibcb1/bioinformatics/yangyue/project/immunotherapy/7.4.cNMF_Mono_Macro/Example_refbuilder_Macro'
prefix = 'starcat_ref'
...
topgene_dir = os.path.join(outdir, "top_genes_by_cGEP_Macro")
