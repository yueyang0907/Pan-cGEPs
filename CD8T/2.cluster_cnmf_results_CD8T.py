...
root = "/sibcb1/bioinformatics/yangyue/project/immunotherapy/7.2.cNMF_CD8T/cnmf_CD8T_out"
...
outdir = '/sibcb1/bioinformatics/yangyue/project/immunotherapy/7.2.cNMF_CD8T/Example_refbuilder_95_v2'
prefix = 'starcat_ref'
...
topgene_dir = os.path.join(outdir, "top_genes_by_cGEP")
